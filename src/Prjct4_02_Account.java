...
public class Prjct4_02_Account {
	...
	public Prjct4_02_Account(String owner, int account, double initial) {
		name = owner;
		acctNumber = account;
		balance = initial;
	}
	public Prjct4_02_Account(String owner, int account) {
		name = owner;
		acctNumber = account;
		balance = 0;
	}
	...
	public void transferMoney(Prjct4_02_Account acct, double amount){
		if(amount > balance){
			System.out.println();
