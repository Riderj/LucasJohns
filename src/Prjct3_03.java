...
public class Prjct3_03 {
	public static void main(String[] args) {
		Scanner scan = new Scanner(System.in);
		int year;
		
		System.out.println("What year do you want to check if it's a leap year?: (0 to quit)");
		year = scan.nextInt();
		...
		while(year != 0){
			...
			System.out.println("What other year do you want to check if it's a leap year?: (0 to quit)");
			year = scan.nextInt();
		}
